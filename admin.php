                ...
                <div class="faq-item admin-faq-item" data-index="<?= $index ?>" data-topic="<?= htmlspecialchars($faq['topic']) ?>">
                 ...
                 <?php if (!empty($faq['attachment'])): ?>
                    <div class="form-group current-attachment-wrapper">
                        ...
                        <div class="attachment-view">
                            <a href="<?= htmlspecialchars($faq['attachment']) ?>" target="_blank">View Current File</a>
                            <button type="button" class="close-attachment" onclick="removeAdminAttachment(this)" title="Remove this file">
                                &times;
                            </button>
                        </div>
                        <input type="hidden" name="remove_existing_attachment" value="0">
                    ...
                    <tr>
                        <form method="POST">
                            ...
                            <td>
                                ...
                                <button type="button" class="modern-btn success" onclick="confirmUpdateUser(<?= $user['id'] ?>, '<?= htmlspecialchars($user['username'], ENT_QUOTES) ?>', this)">
                                    <i class="fas fa-save"></i>
                                </button>
...
<!-- NEW: Deleted FAQs Section -->
    ...
    <div id="updateUserModal" class="modal">
        <div class="modal-content delete-modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="modern-btn secondary" onclick="closeUpdateUserModal()">
                    <i class="fas fa-times"></i>
                    <span>Cancel</span>
                </button>
                <button class="modern-btn success" onclick="updateUser()">
                    <i class="fas fa-save"></i>
    ...
    <script>
        ...
        window.addEventListener('click', function(e) {
            ...
            if (e.target === updateUserModal) closeUpdateUserModal();
        });
